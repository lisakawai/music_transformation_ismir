...
DEFAULT_QUARTERS_PER_MINUTE = 60.0
...
SOS_token = MAX_MIDI_PITCH + 1  # Start of sequence
EOS_token = MAX_MIDI_PITCH + 2  # End of sequence
REST_token = MAX_MIDI_PITCH + 3  # Token for REST

# MAX_SHIFT_STEPS = STEPS_PER_QUARTER * QUARTERS_PER_BAR
MAX_EVENT_LENGTH = 300  # TODO
